        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(onPressed: () {
              if(nameController.text !='' && emailController.text !='' && phoneNumberController.text !='' && passwordController.text !=''){
                if(passwordController.text == confirmPasswordtroller.text){
                  authProvider.signUpUser(emailController.text, passwordController.text, nameController.text);
                  userProvider.addUsers(nameController.text, emailController.text, passwordController.text, phoneNumberController.text);
                  Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (ctx) => const thanksScreen()));
                }else{
                  setState((){
                    isMatched = false;
                  });
